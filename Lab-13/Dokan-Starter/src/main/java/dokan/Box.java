...
public final class Box<T> {
    ...
    public static <T> Box<T> of(T value) {
        if (value == null) throw new NullPointerException("box cannot hold nothing");
    ...
    public T get() {
        if (value == null) throw new IllegalStateException("box cannot hold nothing");
        return value;
    }
    ...
    public String toString() {
        if(value == null ) return "Box(empty)";
        T placeholder = value;
